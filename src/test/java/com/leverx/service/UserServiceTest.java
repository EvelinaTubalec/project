...
class UserServiceTest {
    ...
    void givenUserRequest_whenSaveUser_thenReturnUserResponse() {
        ...
        UserResponseDto userResponseDto = userService.create(new UserRequestDto("firstName", "lastName", "email", "password", "jobTitle", 1L));
    ...
    void givenUserRequest_whenUpdateUser_thenReturnUserResponse() {
        ...
        UserResponseDto updateUserResponseDto = userService.update(new UserRequestDto("newName", "lastName", "email", "password", "jobTitle", 1L), 1L);
