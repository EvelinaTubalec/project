...
class DepartmentServiceTest {
    ...
    void whenFindAll_thenReturnListDepartmentResponse() {
        ...
        departmentResponses.stream().map(DepartmentResponseDto::getTitle).forEach(actualTitle -> {
    ...
    void givenDepartmentRequest_whenSaveDepartment_thenReturnDepartmentResponse() {
        ...
        DepartmentResponseDto departmentDtoResponse = departmentService.create(new DepartmentRequestDto("title"));
    ...
    void givenDepartmentRequestWithoutTitle_whenSaveDepartment_thenReturnNullPointerException(){
        Throwable throwable = assertThrows(Throwable.class, ()->{
            departmentService.create(new DepartmentRequestDto());
        });
    ...
    void givenDepartmentRequest_whenUpdateDepartment_thenReturnDepartmentResponse() {
        ...
        DepartmentResponseDto actualDepartmentResponseDto = departmentService.update(new DepartmentRequestDto("new"), 1L);
    ...
    void givenDepartmentRequest_whenUpdateDepartmentNonExistingDepartment_thenReturnResponseStatusException() {
        Department department = new Department(1L, "title");
        when(departmentRepository.findById(department.getId())).thenThrow(new ResponseStatusException(HttpStatus.BAD_REQUEST,
